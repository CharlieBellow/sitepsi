...
export default function CallToAction() {
  return (
    <div className='px-8 retative text-white space-y-5 sm:space-y-20 absolute z-50 text-lg max-w-xs sm:max-w-xl lg:max-w-3xl '>
      <div className='text-lg'>
      <h1 className='text-2xl md:text-4xl font-bold'>Charlie Bellow de Oliveira Pimentel Silva</h1>
      <h2 className='text-lg lg:text-2xl font-bold'>Psicólogo - CRP 15/5997</h2>
      </div>
